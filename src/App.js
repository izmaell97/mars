            ...
            <Grid container spacing={1} justify="stretch">
                <Grid item xl={4} xs={4}
                    ...
                    // justify-items= "stretch"
                      ...
                      justify="center"
                >
                    <span style={classes.one}> <ResourceCounter text={<EuroSymbolIcon/>} count={state.mEuro} id="mEuro"
                                                                    dispatch={dispatch}
                                                                    background={colour.whiteBackground}
                                                                    color={colour.whiteColour} colorBorder={colour.whiteBackground}/>  </span>
                    <span style={classes.one}>  <ResourceCounter text={<LanguageIcon/>} count={state.wt} id="wt"
                                                                     dispatch={dispatch}
                                                                     background={colour.whiteBackground}
                ...
                <Grid item xl={4} xs={4}>
                    <ResourceCounter text={<EnergySavingsLeafIcon/>} count={state.bio} id="bio" dispatch={dispatch}
                ...
                <Grid item xl={4} xs={4}>
                    <ResourceCounter text={<EnergySavingsLeafIcon/>} count={state.bioNumber} id="bioNumber"
               ...
               <Grid item xl={4} xs={4}>
                ...
                <Grid item xl={12}>
                    <Button fullWidth variant="contained" onClick={() => dispatch({type: 'nextRound'})}
                            sx={classes.button}>Nowa Runda</Button>
                </Grid>
                <Grid item xl={12}>
                    <Button fullWidth variant="contained" onClick={() => dispatch({type: 'reset'})}
                            sx={classes.button}>Zeruj</Button>
                </Grid>
